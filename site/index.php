---
page.title = "HexR"
extra-footer = "<link rel='stylesheet' href='/assets/css/animations.home.css' type='text/css' /><script type=\"text/javascript\">$(\".parallax\").parallax(); var o = [{selector: '#benefit-1', offset: 200, callback: '$(\"#benefit-1\").children().addClass(\"animated slideInRight\").removeClass(\"hide\");'},{selector: '#benefit-2', offset: 200, callback: '$(\"#benefit-2\").children().addClass(\"animated slideInLeft\").removeClass(\"hide\");'},{selector: '#benefit-3', offset: 200, callback: '$(\"#benefit-3\").children().addClass(\"animated slideInRight\").removeClass(\"hide\");'},{ selector: '#benefit-4', offset: 200, callback: '$(\"#benefit-4\").children().addClass(\"animated slideInLeft\").removeClass(\"hide\");'},{selector: '#benefit-5', offset: 200, callback: '$(\"#benefit-5\").children().addClass(\"animated slideInRight\").removeClass(\"hide\");'},{selector: '#benefit-6', offset: 200, callback: '$(\"#benefit-6\").children().addClass(\"animated slideInLeft\").removeClass(\"hide\");'},{selector: '#contact', offset: 100, callback: '$(\"#contact\").children().addClass(\"animated rotateIn\").delay(1000).removeClass(\"rotateIn\").addClass(\"flash\")'},]; if($(window).width() >= 922) Materialize.scrollFire(o); else $('.section .row').removeClass('hide').addClass('center');</script>"
---
<div id="index-banner" class="parallax-container">
    <div class="section no-pad-bot">
        <div class="container">
            <h1 class="header col s12 center blue-grey-text text-darken-3">HexR</h1>
            <h4 class="header col s12 center flow-text blue-grey-text text-darken-3" id="subtitle">Custom websites on a whole new level</h4>
            <br/>
            <div class="row center">
                <a href="/about" class="btn-large waves-effect waves-light hexr-background z-depth-1">Learn More</a>
            </div>
            <br>
            <br>
        </div>
        <div class="parallax" id="ken-burns">
            <img src="/assets/img/hero.jpeg" alt="Hot air baloons to symbolize the new level" />
        </div>
    </div>
</div>
<div class="section animated fadeInUp" id="intro">
    <div class="row container">
        <div class="col s12 m12 l12">
            <p class="flow-text white-text">HexR. The only organization dedicated to producing websites of any scale to anyone who needs it. From the smallest individual to the largest business, we're ready to take on any web design challenge. But you might be wondering why you should choose us. Here's 6 reasons why! (If you don't see anything, scroll down a little bit).</p>
        </div>
    </div>
</div>
<div class="section section-1 z-depth-5 valign-wrapper" id="benefit-1">
    <div class="row container hide valign">
        ...
        <div class="col s12 m7 l7 right-align">
            ...
            <span class="flow-text">When you choose HexR to write your website, you will get simple, clean, efficient and hack-free code. Everything works. Everywhere.</span>
        </div>
    </div>
</div>
<div class="section section-2 z-depth-4 valign-wrapper" id="benefit-2">
    <div class="row container hide valign">
        ...
        <div class="col s12 m5 l5 right-align benefit-icon"><i class="material-icons large">settings_overscan</i></div>
    </div>
</div>
<div class="section section-3 z-depth-3 valign-wrapper opposite" id="benefit-3">
    <div class="row container hide valign">
        ...
        <div class="col s12 m7 l7 right-align">
            <h3>Inexpensive</h3>
            <span class="flow-text">You probably will get the design we produce for free. That's because of our <a href="/initiative" class="red-text text-darken-4">Initiative</a> to make websites. We also have access to many tools and services at a lower rate.</span>
        </div>
    </div>
</div>
<div class="section section-1 z-depth-2 valign-wrapper opposite" id="benefit-4">
    <div class="row container hide valign">
        ...
        <div class="col s12 m5 l5 right-align benefit-icon"><i class="material-icons large">dashboard</i></div>
    </div>
</div>
<div class="section section-2 z-depth-1 valign-wrapper opposite" id="benefit-5">
    <div class="row container hide valign">
        ...
        <div class="col s12 m7 l7">
            ...
            <span class="flow-text right-align">Most HexR sites use the <a href="https://www.wordpress.org/" target="_blank" class="red-text text-darken-4">WordPress</a> CMS. The open-source nature of the platform makes it possible to have a robust, secure website.</span>
        </div>
    </div>
</div>
<div class="section section-3 valign-wrapper" id="benefit-6" data-animate="jello">
    <div class="row container hide valgin">
        <div class="col s12 m7 l7">
            <h3>Support</h3>
        ...
        <div class="col s12 m5 l5 right-align benefit-icon"><i class="material-icons large">live_help</i></div>
    </div>
</div>
<div class="section center white-text valign" id="contact">
    <div class="valign">
        <p class="flow-text">So what are you waiting for?</p>
        <a class="modal-trigger btn flow-text waves-effect waves-light hexr-background" href="#request">GET YOUR WEBSITE NOW!</a>
        <br/>
        <br/>
    </div>
</div>
<div id="request" class="modal">
    <div class="modal-content row">
        ...
        <form action="/request/post.php" method="post" class="col s12">
            ...
            <div class="row">
                <button type="submit" class="btn waves-effect waves-effect-light">Submit</button>
